...
var require_iso8601 = __commonJS({
  "node_modules/iso8601-js-period/iso8601.js"(exports, module) {
...
var require_leaflet_timedimension_src = __commonJS({
  "node_modules/leaflet.timedimension/dist/leaflet.timedimension.src.js"(exports, module) {
    (function(factory, window2) {
      if (typeof define === "function" && define.amd) {
        define(["leaflet", "iso8601-js-period"], factory);
      } else if (typeof exports === "object") {
        module.exports = factory(require_leaflet_src(), require_iso8601());
      } else if (typeof window2 !== "undefined" && window2.L && typeof L !== "undefined") {
        var iso8601 = nezasa.iso8601;
        window2.L.TimeDimension = factory(L, iso8601);
      }
    })(function(L2, iso8601) {
      if (typeof nezasa2 === "undefined") {
        var nezasa2 = { iso8601 };
      }
      ...
      L2.TimeDimension.Util = {
        getTimeDuration: function(ISODuration) {
          ...
          return nezasa2.iso8601.Period.parse(ISODuration, true);
        },
      ...
      L2.timeDimension.layer = function(layer, options) {
        return new L2.TimeDimension.Layer(layer, options);
      };
      L2.TimeDimension.Layer.WMS = L2.TimeDimension.Layer.extend({
        initialize: function(layer, options) {
          L2.TimeDimension.Layer.prototype.initialize.call(this, layer, options);
        ...
        eachLayer: function(method, context) {
          ...
          return L2.TimeDimension.Layer.prototype.eachLayer.call(this, method, context);
        },
        _onNewTimeLoading: function(ev) {
      ...
      L2.timeDimension.layer.wms = function(layer, options) {
        return new L2.TimeDimension.Layer.WMS(layer, options);
      };
      L2.TimeDimension.Layer.GeoJson = L2.TimeDimension.Layer.extend({
        ...
        _update: function() {
          ...
          var layer = L2.geoJson(null, this._baseLayer.options);
      ...
      L2.timeDimension.layer.geoJson = function(layer, options) {
        return new L2.TimeDimension.Layer.GeoJson(layer, options);
      };
...
export default require_leaflet_timedimension_src();
//# sourceMappingURL=leaflet__timedimension.js.map
